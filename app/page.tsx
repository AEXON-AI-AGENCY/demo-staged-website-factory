...
const VERTICALS = {
  ...
  electrician:   { name: "Current Electric LLC",        industry: "Electrical",     accent: "#00e5ff", description: "Professional electrical services website with safety certifications front-and-center, service-specific landing pages, and instant scheduling.", demoUrl: "/demo/electrical" },
