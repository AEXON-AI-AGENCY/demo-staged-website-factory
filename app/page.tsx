    ...
    <div className="min-h-screen bg-[var(--color-bg)] text-zinc-100">
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <h1 className="animate-fade-up animate-delay-200 text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight leading-[0.55] mb-2 font-['Inter','var(--font-inter)']">
